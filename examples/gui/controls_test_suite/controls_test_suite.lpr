...
uses CocoaAll, cmem, raygui, raylib, fontutil;
...
begin
 ...
 // Font := LoadUnicodeFont(16,'Cornerita_Regular.ttf');
 // GuiSetFont(Font);
  //--------------------------------------------------------------------------------------
  // Main game loop
  while not exitWindow do
    begin
      ...
      BeginDrawing();
        ...
        // First GUI column
        GuiCheckBox(RectangleCreate( 25, 108, 15, 15 ), 'ТЕСТ ГУИ!', @forceSquaredChecked);
