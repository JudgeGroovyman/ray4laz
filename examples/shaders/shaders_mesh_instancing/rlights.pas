...
begin
  ...
  begin
    ...
    Result.EnabledLoc := GetShaderLocation(Shader, TextFormat(UTF8String('lights[%i].enabled'), LightsCount));
    Result.TypeLoc := GetShaderLocation(Shader, TextFormat(UTF8String('lights[%i].type'), LightsCount));
    Result.PositionLoc := GetShaderLocation(Shader, TextFormat(UTF8String('lights[%i].position'), LightsCount));
    Result.TargetLoc := GetShaderLocation(Shader, TextFormat(UTF8String('lights[%i].targe'), LightsCount));
    Result.ColorLoc := GetShaderLocation(Shader, TextFormat(UTF8String('lights[%i].color'), LightsCount));
